...
public class App {
	...
	public static void main(String[] args) throws IOException, IllegalArgumentException, IllegalAccessException {
		...
		String queryCode2 =  
				...
				"    }";
		Recommender recommender = new Recommender(highScoreCodeSnipsFile, vectorsFileHigh, queryCode2, null);
		
		
		List<Pair<Long, Double>> IdsAndDistance = recommender.getTopSnips(10, Recommender.Distance.COSINE);
		...
		/*Evaluation evaluation8 = new Evaluation(highScoreCodeSnipsFile, vectorsFileHigh, 
				133870, 1000, 10,
				Recommender.Distance.EUCLIDEAN, Evaluation.Pruning.STATEMENTS);
		evaluation8.evaluate();
		evaluation8.printResults();
		
		Evaluation evaluation9 = new Evaluation(highScoreCodeSnipsFile, vectorsFileHigh, 
				133870, 1000, 10,
				Recommender.Distance.EUCLIDEAN, Evaluation.Pruning.IDENTIFIERS);
		evaluation9.evaluate();
		evaluation9.printResults();
		
		Evaluation evaluation10 = new Evaluation(highScoreCodeSnipsFile, vectorsFileHigh, 
				133870, 1000, 10,
				Recommender.Distance.EUCLIDEAN, Evaluation.Pruning.NONE);
		evaluation10.evaluate();
		evaluation10.printResults();*/
...
evaluation9.printResults();*/
		...
		/*Evaluation evaluation1 = new Evaluation(shortCodeSnipsFile, vectorsFileShort, 6700, 50, 10,
				Recommender.Distance.EUCLIDEAN);
		evaluation1.evaluate();
		evaluation1.printResults();

		Evaluation evaluation2 = new Evaluation(shortCodeSnipsFile, vectorsFileShort, 6700, 100, 5,
				Recommender.Distance.EUCLIDEAN);
		evaluation2.evaluate();
		evaluation2.printResults();

		Evaluation evaluation3 = new Evaluation(shortCodeSnipsFile, vectorsFileShort, 6700, 100, 5,
				Recommender.Distance.COSINE);
		evaluation3.evaluate();
		evaluation3.printResults();

		Evaluation evaluation4 = new Evaluation(shortCodeSnipsFile, vectorsFileShort, 6700, 1000, 5,
				Recommender.Distance.EUCLIDEAN);
		evaluation4.evaluate();
		evaluation4.printResults();

		Evaluation evaluation5 = new Evaluation(shortCodeSnipsFile, vectorsFileShort, 6700, 1000, 10,
				Recommender.Distance.EUCLIDEAN);
		evaluation5.evaluate();
		evaluation5.printResults();

		Evaluation evaluation6 = new Evaluation(shortCodeSnipsFile, vectorsFileShort, 6700, 1000, 5,
				Recommender.Distance.COSINE);
		evaluation6.evaluate();
		evaluation6.printResults();

		Evaluation evaluation7 = new Evaluation(shortCodeSnipsFile, vectorsFileShort, 6700, 1000, 10,
				Recommender.Distance.COSINE);
		evaluation7.evaluate();
		evaluation7.printResults();*/

// 133870

		/*Evaluation evaluation8 = new Evaluation(highScoreCodeSnipsFile, vectorsFileHigh, 133870, 1000, 5,
				Recommender.Distance.EUCLIDEAN, true);
		evaluation8.evaluate();
		evaluation8.printResults();

		Evaluation evaluation9 = new Evaluation(highScoreCodeSnipsFile, vectorsFileHigh, 133870, 1000, 10,
				Recommender.Distance.EUCLIDEAN, false);
		evaluation9.evaluate();
		evaluation9.printResults();

		Evaluation evaluation10 = new Evaluation(highScoreCodeSnipsFile, vectorsFileHigh, 133870, 1000, 5,
				Recommender.Distance.COSINE, false);
		evaluation10.evaluate();
		evaluation10.printResults();

		Evaluation evaluation11 = new Evaluation(highScoreCodeSnipsFile, vectorsFileHigh, 133870, 1000, 10,
				Recommender.Distance.COSINE, false);
		evaluation11.evaluate();
		evaluation11.printResults();*/
	}
